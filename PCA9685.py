...
class PWM(object):
    ...
    def __init__(self, bus_number=6, address=0x40):
        ...
        self.bus = mraa.I2c(self.bus_number) #Initialization of I2C#smbus.SMBus(self.bus_number)
        self.bus.address(self._i2caddr)
        if self._DEBUG:
